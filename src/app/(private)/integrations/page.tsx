...
import { Database, ShieldCheck, Mail, KeyRound, Cpu } from 'lucide-react';
    ...
    <PageTransition>
      <div className="space-y-6">
        ...
        <div className="border-b pb-4">
          ...
          <p className="text-xs text-zinc-500 font-medium">Диагностика работоспособности внешних шлюзов, задержек (Latency) и ошибок обмена данными.</p>
        </div>
            ...
            return (
              <div key={node.name} className="rounded-lg border border-zinc-200 bg-white p-6 shadow-sm space-y-4">
                <div className="flex justify-between items-start">
                  ...
                  <Badge label={node.status} variant={getStatusVariant(node.status)} />
                </div>
